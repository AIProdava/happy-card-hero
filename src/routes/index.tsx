    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/10">
      ...
      <main className="px-6 py-8 lg:py-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-12 lg:gap-16 items-start">
          <section className="animate-reveal lg:sticky lg:top-28">
            <div className="relative aspect-[4/5] w-full max-w-lg mx-auto lg:max-w-none rounded-[calc(var(--radius)+12px)] overflow-hidden shadow-2xl shadow-primary/5 ring-1 ring-black/5 bg-white">
              <img
        ...
        <footer className="mt-16 pt-12 pb-8 border-t border-border flex flex-col items-center gap-4">
